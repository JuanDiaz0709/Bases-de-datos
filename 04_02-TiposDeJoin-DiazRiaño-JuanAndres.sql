...
SELECT c.customer_id AS id_cliente, concat(c.first_name," ", c.last_name) as nombre_completo, count(r.rental_id) as cantidad_alquileres
FROM customer c
JOIN rental r ON c.customer_id = r.customer_id
GROUP BY c.customer_id
HAVING cantidad_alquileres > 1
